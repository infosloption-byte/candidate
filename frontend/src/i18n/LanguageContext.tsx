...
const he: TranslationMap = {
  ...
  "Edit interviewer account": "עריכת חשבון מראיין",
  "Interviewer account was updated.": "חשבון המראיין עודכן.",
  "Unable to update the interviewer.": "לא ניתן לעדכן את המראיין.",
