...
export const InterviewPage = () => {
  ...
  const selectCalendarInterview = (interviewId: string) => {
    ...
    <div className="flex min-h-full flex-col bg-slate-50">
      <header className="border-b border-slate-200 bg-white px-4 py-4 sm:px-6">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            <div className="flex flex-wrap items-center gap-2"><h1 className="text-2xl font-black tracking-tight text-slate-950">Interviews</h1><span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-bold text-slate-600">{metrics.total}</span></div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {mode === 'queue' && <div className="grid grid-cols-4 gap-2 sm:min-w-[420px]">
