...
export const TopBar = ({ title, subtitle, onSearch, searchValue }: TopBarProps) => {
  ...
  return <header className="sticky top-0 z-30 flex min-h-16 items-center gap-3 border-b border-slate-200 bg-white/92 px-3 backdrop-blur-xl sm:px-5">
    ...
    <div className="flex items-center gap-2"><div className="grid size-9 place-items-center rounded-full bg-slate-900 text-xs font-bold text-white">RC</div><div className="hidden lg:block"><p className="text-xs font-bold text-slate-800">Recruitment Team</p><p className="text-[10px] text-slate-500">Recruiter</p></div></div>
  </header>;
};
